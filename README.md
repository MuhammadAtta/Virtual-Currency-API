...
Project Overview: We need an API that allows users to send virtual currency to each other.
...
Open application.properties file Change your MySQL database (username & password)
...
signup.PNG This will return a JSON with the user, and the token that will give access to the system. Note: The Token is valid for 30 minutes.
